...
Component.options.__file = "/Users/easonzhan/learning/git_repos/webpack-tutorial/04-vue-ssr/src/App.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6db74a57", Component.options)
  } else {
    hotAPI.reload("data-v-6db74a57", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6db74a57", module.exports)
  }
}
		...
		routes: [
		  {
		    path: '/',
		    name: 'index',
		    component: () => new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 2))
		  },
		  {
		    path: '/bar',
		    name: 'bar',
...
function createStore () {
	return new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
		...
		actions: {
			fetchItem ({commit}, id) {
				return __WEBPACK_IMPORTED_MODULE_2__api__["a" /* fetchItem */](id).then(item => {
